...
xp=2.5:0.01:4.2;
yp= p12(1) + p12(2)*xp + p12(3)*xp.^2 + p12(4)*xp.^3 + p12(5)*xp.^4;
...
xr=fzero(@(x) p12(1) + p12(2)*x + p12(3)*x^2 + p12(4)*x^3 + p12(5)*x^4 - g2Target,xInit);
...
xp=2.5:0.01:4.2;
yp2= p24(1) + p24(2)*xp + p24(3)*xp.^2 + p24(4)*xp.^3 + p24(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);

for i=1:N

xpp=xroot12(i);
ypp=p24(1) + p24(2)*xpp + p24(3)*xpp^2 + p24(4)*xpp^3 + p24(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp= p16(1) + p16(2)*xp + p16(3)*xp.^2 + p16(4)*xp.^3 + p16(5)*xp.^4;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p16(1) + p16(2)*x + p16(3)*x^2 + p16(4)*x^3 + p16(5)*x^4 - g2Target,xInit);

xroot16(i)=xr;
beta16Tuned(i)=xroot16(i);

xpp=xroot16(i);
ypp=p16(1) + p16(2)*xpp + p16(3)*xpp^2 + p16(4)*xpp^3 + p16(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp2= p32(1) + p32(2)*xp + p32(3)*xp.^2 + p32(4)*xp.^3 + p32(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);

for i=1:N

xpp=xroot16(i);
ypp=p32(1) + p32(2)*xpp + p32(3)*xpp^2 + p32(4)*xpp^3 + p32(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp= p18(1) + p18(2)*xp + p18(3)*xp.^2 + p18(4)*xp.^3 + p18(5)*xp.^4;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p18(1) + p18(2)*x + p18(3)*x^2 + p18(4)*x^3 + p18(5)*x^4 - g2Target,xInit);

xroot18(i)=xr;
beta18Tuned(i)=xroot18(i);

xpp=xroot18(i);
ypp=p18(1) + p18(2)*xpp + p18(3)*xpp^2 + p18(4)*xpp^3 + p18(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp2= p36(1) + p36(2)*xp + p36(3)*xp.^2 + p36(4)*xp.^3 + p36(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);

for i=1:N

xpp=xroot18(i);
ypp=p36(1) + p36(2)*xpp + p36(3)*xpp^2 + p36(4)*xpp^3 + p36(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp= p20(1) + p20(2)*xp + p20(3)*xp.^2 + p20(4)*xp.^3 + p20(5)*xp.^4;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p20(1) + p20(2)*x + p20(3)*x^2 + p20(4)*x^3 + p20(5)*x^4 - g2Target,xInit);

xroot20(i)=xr;
beta20Tuned(i)=xroot20(i);

xpp=xroot20(i);
ypp=p20(1) + p20(2)*xpp + p20(3)*xpp^2 + p20(4)*xpp^3 + p20(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp2= p40(1) + p40(2)*xp + p40(3)*xp.^2 + p40(4)*xp.^3 + p40(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);

for i=1:N

xpp=xroot20(i);
ypp=p40(1) + p40(2)*xpp + p40(3)*xpp^2 + p40(4)*xpp^3 + p40(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.5:0.01:4.2;
yp= p24(1) + p24(2)*xp + p24(3)*xp.^2 + p24(4)*xp.^3 + p24(5)*xp.^4;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p24(1) + p24(2)*x + p24(3)*x^2 + p24(4)*x^3 + p24(5)*x^4 - g2Target,xInit);
...
xp=2.5:0.01:4.2;
% xp=2.:0.01:5;
yp2= p48(1) + p48(2)*xp + p48(3)*xp.^2 + p48(4)*xp.^3 + p48(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);

for i=1:N

xpp=xroot24(i);
ypp=p48(1) + p48(2)*xpp + p48(3)*xpp^2 + p48(4)*xpp^3 + p48(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.4:0.01:4.2;
yp= p8(1) + p8(2)*xp + p8(3)*xp.^2 + p8(4)*xp.^3 + p8(5)*xp.^4 + p8(6)*xp.^5;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p8(1) + p8(2)*x + p8(3)*x^2 + p8(4)*x^3 + p8(5)*x^4 + p8(6)*x^5 - g2Target,xInit);

xroot8(i)=xr;
beta8Tuned(i)=xroot8(i);

xpp=xroot8(i);
ypp=p8(1) + p8(2)*xpp + p8(3)*xpp^2 + p8(4)*xpp^3 + p8(5)*xpp^4 + p8(6)*xpp^5  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4; xpp^5];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.4:0.01:4.2;
% xp=2.:0.01:5;
yp2= p16(1) + p16(2)*xp + p16(3)*xp.^2 + p16(4)*xp.^3 + p16(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);
...
xp=2.4:0.01:4.2;
yp= p10(1) + p10(2)*xp + p10(3)*xp.^2 + p10(4)*xp.^3 + p10(5)*xp.^4;
plot(xp,yp,'-b','LineWidth',1);
...
xr=fzero(@(x) p10(1) + p10(2)*x + p10(3)*x^2 + p10(4)*x^3 + p10(5)*x^4 - g2Target,xInit);

xroot10(i)=xr;
beta10Tuned(i)=xroot10(i);

xpp=xroot10(i);
ypp=p10(1) + p10(2)*xpp + p10(3)*xpp^2 + p10(4)*xpp^3 + p10(5)*xpp^4  ;
xvec=[1; xpp; xpp^2; xpp^3; xpp^4];
% delta=ypp^2*sqrt(xvec'*(C*xvec));
delta=sqrt(xvec'*(C*xvec));
ypp;
...
xp=2.4:0.01:4.2;
% xp=2.:0.01:5;
yp2= p20(1) + p20(2)*xp + p20(3)*xp.^2 + p20(4)*xp.^3 + p20(5)*xp.^4;
plot(xp,yp2,'-c','LineWidth',1);
...
% title('SSC gradient flow with unimproved s=1.5 step scaling function','fontsize',14)
title('SSC  c = 0.30  s = 2.0   beta function','fontsize',14)
